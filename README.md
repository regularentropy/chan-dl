...
[![Python](https://img.shields.io/badge/python-3.14+-3670A0?logo=python&logoColor=white)]()
...
3. After downloading a thread, use `python -m http.server` in it's root (or other http server) to browse the downloaded content locally.
